    ...
    >
      <svg width="350" height="120" style={{ overflow: 'visible' }}>
        ...
        <g transform={`translate(${separatePos.love.x}, ${-15 + separatePos.love.y}) rotate(-8, 100, 50)`}>
          ...
          {/* Antennae on L (head of LOVE bug) - clearly visible */}
          <line x1="7" y1="0" x2="2" y2="-18" stroke="#000" strokeWidth="3" strokeLinecap="round" />
          <line x1="20" y1="0" x2="25" y2="-18" stroke="#000" strokeWidth="3" strokeLinecap="round" />
          <circle cx="2" cy="-18" r="4.5" fill="#000" />
          <circle cx="25" cy="-18" r="4.5" fill="#000" />
        </g>
        ...
        <g transform={`translate(${200 + separatePos.bug.x}, ${15 + separatePos.bug.y}) rotate(8, 75, 50)`}>
          ...
          {/* Antennae on B (head of BUG bug) - clearly visible */}
          <line x1="7" y1="0" x2="2" y2="-18" stroke="#000" strokeWidth="3" strokeLinecap="round" />
          <line x1="20" y1="0" x2="25" y2="-18" stroke="#000" strokeWidth="3" strokeLinecap="round" />
          <circle cx="2" cy="-18" r="4.5" fill="#000" />
          <circle cx="25" cy="-18" r="4.5" fill="#000" />
...
export default function LoveBug2() {
